...
public final class ApiPath {
    ...
    private static final String ENTRY_ENC = "entryenc/";
    private static final String ACL_GRP = "aclgroup/";
    ...
    private static final String API_ACL_GRP = API + ACL_GRP;
    ...
    private static final String API_ENTRY_ENC = API + ENTRY_ENC;
