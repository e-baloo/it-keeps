...
public class rImage {
    ...
    public Response updateEnc(final jImage j) {
        ...
        return Response.ok().entity(fImage.read(requesterRid, j.getId().getSimple())).build();
    }
    ...
    public Response create(final jImage j) {
        ...
        return Response.ok().entity(fImage.read(requesterRid, image.getId().getSimple())).build();
    }
