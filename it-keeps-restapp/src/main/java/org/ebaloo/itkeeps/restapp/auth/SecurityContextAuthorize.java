...
public class SecurityContextAuthorize implements SecurityContext {

    private Principal principal;
    private javax.inject.Provider<UriInfo> uriInfo;
    private enRole role = null;

    public SecurityContextAuthorize(javax.inject.Provider<UriInfo> uriInfo, String guid, enRole role) {
